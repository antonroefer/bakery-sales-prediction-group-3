...
# Create 'Salesgroup6' column: 1 if there are sales for Warengruppe 6 on that day, else 0
salesgroup6_days = data[data["Warengruppe"] == 6].groupby("Datum").size().index
data["Advent"] = data["Datum"].isin(salesgroup6_days).astype(int)
