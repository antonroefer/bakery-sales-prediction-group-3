...
schulferien = pd.read_csv("Input_Data/Schulferien.csv")
data = pd.merge(data, schulferien, on="Datum", how="left")

# Load Feiertage_SH.csv
feiertage = pd.read_csv("Input_Data/Feiertage_SH.csv")
...
wahltage = pd.read_csv("Input_Data/wahltage_binaer.csv")
...
vpi = pd.read_csv("Input_Data/VPI_modified.csv")
